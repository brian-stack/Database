...
template <typename T>
void orderedInsert(T data[ ], int& n, T entry);
...
template <typename T>
void attachItem(T data[ ], int& n, const T& entry);

//insert entry at index i in data
template <typename T>
void insertItem(T data[ ], int i, int& n, T entry);

//remove the last element and return it.
template <typename T>
T detachItem(T data[ ], int& n);

//delete item at index i return it.
template <typename T>
T deleteItem(T data[ ], int i, int& n);

//append data2 to the back of data1
template <typename T>
void mergeArrays(T dest[], int& destSize, T source[], int& sourceSize);

//insert data2 at the front of data1
template <typename T>
void mergeFront(T dest[ ], int& destSize, T source[ ], int& sourceSize);

//move n/2 elements from the right of data1 and move to data2
template <typename T>
void split(T data1[ ], int& n1, T data2[ ], int& n2, bool includeMid = false);
...
template <typename T>
void split(T data1[], int& n1, T data2[], int& n2, bool includeMid)
{
    if(includeMid)
    {
